...
const About = () => {
    return (
        <>
            ...
            {/* About Section */}
            <div className="about-container-fluid pt-4" style={{backgroundColor:"#f4f4f4"}}>
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-md-5 details-txt">
                            ...
                            <div className="about-text">
                                <div className="tb-section-heading tb-style2">
                                    <h1 style={{fontSize:"30px"}}>Welcome to One Point</h1>
                                    <div className="mt-separator-outer mb-2" >
                                        <div className="mt-separator " style={{backgroundColor:"#ff0022"}}> </div>
                                    </div>
                                    <p>
                                        ...
                                        appliance maintenance. At One Point, we're more than just a repair service; we're
